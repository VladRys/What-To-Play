...
class Config:
    def __init__(self):
        ...
        self.DB_PATH = os.getenv("DB_PATH", str(Path(__file__).resolve().parent / "db" / "steam_games.db"))
        self.GAME_REPOSITORY_MODEL_PATH = str(Path(__file__).resolve().parent / "db" / "models.sql") # Path to SQL file for creating the games table
